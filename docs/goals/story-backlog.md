...
- **2026-06-27 第5イテレーション**: 段階1バッチ `ext-stage1-daily.json`(daily新語24=暮らし/家事/住まいの道具L1-2。8系統で唯一未拡張だったdailyを着手)→ DB 950→**974**(daily126・系統上限625内)。サブ1本: `sub_c09_hearthlight`「集積核の、小さな住まい」(ch9「集積核」呑まれた者の暮らしの跡に絡む・daily8語: lamp/candle/blanket/sheet/mug/broom/mirror/soap)。2-2-review-1-1-2-review構成・物語フラグ非干渉。これで**ch2〜ch9の全章にサブ1本ずつ配備完了**(sub_c02〜sub_c09)。106テスト+smoke green。
