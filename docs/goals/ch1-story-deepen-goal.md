...
2. 【決裁済み】**ch1は幼少期の話** → 挿絵概要は主人公たちを**幼少期の姿**で記述。
...
## 停止
- 上記完了で push 後「**停止点A**」を報告（go 後に幼少期の見た目で挿絵を作り直す別フェーズ）。
  **画像生成・HTML作成・ゲーム組込みはやらない**。
- 幼少期の**具体的見た目年齢**が物語記述に影響して判断に迷う場合のみ needs input で停止
  （挿絵概要は「年少の子供」として書いて進めてよい）。
